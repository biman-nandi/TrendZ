        ...
        <div className="mt-20 py-10 px-2 md:px-5 lg:px-20 bg-[#121212] grid lg:grid-cols-4 text-white relative gap-4">
            <div>
                ...
                <div className="flex gap-5 mb-5">
                    <svg viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="30px">
                    ...
                    <svg fill="#ffffff" width="40px" viewBox="-5.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier"> 
            ...
            <div>
                <p className="mb-1.5"><span className=" hover:underline cursor-pointer">SHOP ALL</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">TRAIL</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">ACTIVE</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">SNOW</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">SIZE CHART</span></p>
                <p><span className=" hover:underline cursor-pointer">ABOUT US</span></p>
            </div>

            <div>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">FAQ</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">RETURNS</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">ORDER TRACK</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">WARRANTY</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">CAREERS</span></p>
                <p><span className=" hover:underline cursor-pointer">ACCESSIBILITY</span></p>
            </div>

            <div>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">STORE LOCATOR</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">WHOLESALE</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">SLACK CHANNEL</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">HALFDAYS EVENTS</span></p>
                <p className="mb-1.5 "><span className=" hover:underline cursor-pointer">PRIVATE EVENTS</span></p>
                <p><span className=" hover:underline cursor-pointer">CONTACT Us</span></p>
            </div>
            
            <label htmlFor="curr" className="flex justify-between">
                <select name="curr" id="curr" className="bg-[#121212] sm:absolute right-2 top-10 text-sm outline-none">
                    <option>AUD</option>
                    <option>CAD</option>
                    <option>GBP</option>
                    <option>INR</option>
                ...
                <div className="text-center inline sm:absolute bottom-5 right-2">
                    <p className="text-sm inline cursor-pointer">BACK TO THE TOP <span className="text-xl">↑</span></p>
                </div>
            </label>
        </div>
    )
